      ...
      <div class="control-panel" style="display:none;">
        <div class="panel-top">
          ...
          <div class="content-panel-right content-panel-right-full-width"
            style="display: none; vertical-align: text-bottom; width: 80%;">
            ...
            <div class="display-inline-block full-with float-left" style="padding-bottom: 15px;">
              ...
              <div class="display-inline-block float-left" style="width: 49%;">
                <div class="display-inline-block float-right" style="margin-bottom: 10px;">
                  ...
                  <b-form-select class="form-control input-content min-height-43-px display-inline-block width-163-px"
                    style="width: auto;" v-model="paymentMethod" :options="paymentMethodOption"></b-form-select>
                </div>
                <div class="display-inline-block float-right" v-if="paymentMethod">
                  <div class="display-inline-block" v-if="customer_select">
                    ...
                    <b-form-input type="number" class="form-control min-height-43-px display-inline-block width-163-px"
                      style="width: auto;" v-model="payment" v-on:change="checkToEnableBtn()"></b-form-input>
                    <span class="text-danger"
                      v-if="checkingPaymentInput() && payment > 0 && isSubmit === false">មិនអាចបញ្ចូលចំនួនលើស</span>
                  </div>
                </div>
                <div class="display-inline-block float-right" style="width: 45%; margin-top: 10px;">
                  <div class="display-inline-block float-right" v-if="payment > 0 && isSubmit === false">
                    <b-button :disabled="checkingPaymentInput() && payment > 0 && isSubmit === false"
                      class="min-height-43-px width-163-px" size="sm" title="រក្សារការទូទាត់" variant="success"
                      @click="submitPayment()">រក្សារការទូទាត់</b-button>
                  </div>
                </div>
              </div>
            </div>
