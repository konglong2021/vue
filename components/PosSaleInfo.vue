...
<div style="overflow-y:auto;max-height:650px;">
     ...
     <b-form enctype="multipart/form-data" >
        <div class="full-content">
          <div class="container-row-form width-45-percentage float-left">
            <div class="form-row-content-detail">
              ...
              <div class="form-column-input">
                <b-form-select class="form-control input-content" 
          ...
          <div class="container-row-form width-45-percentage float-right">
            <div class="form-row-content-detail">
              ...
              <div class="form-column-input">
                <b-form-input type="number" 
                min="0" class="input-content" v-model="discount" ></b-form-input>
              </div>
            </div>
            <div class="form-row-content-detail">
              <div class="form-column-label">
        ...
        <div>
            ...
            <div class="form-row-content-money pull-left">
              ...
              <div class="form-column-input">
                <b-form-input :id="'input-getting-money-riel'" 
                    type="number" 
                    min="0"
                  class="input-content" 
                    step="100"
             ...
             <div class="line"></div>
              <div class="total" style="cursor:pointer" @click="inputReturn()">
                ...
                <div class="pull-right" >
                    <div class="pull-left" v-if="showInputReturn">
                        <b-form-input :id="'input-return-usd'" 
                         @keyup.enter="updateInputReturn()"
                         @keyup.esc="cancelInputReturn()"
                          type="number" 
                          class="input-content" 
              ...
              <div class="total">
                ...
                <div class="content-btn pull-left">
                      <b-button class="btn-payment"
                                v-show="showPrintReceipt"
                                v-bind:disabled = "printItems.length === 0"
                                @click="printReceipt()"
                      >
  ...
  <div id="pos-invoice" style="display: none; height: 100%; overflow: hidden; padding: 30px 70px !important; font-family: 'Arial', 'Khmer OS Bokor', sans-serif !important; width: 95%; margin: 15px;">
      ...
      <div class="full-content">
        <div class="container-row-form width-60-percentage float-left">
          ...
          <div class="form-row-content-detail row-content-view">
            ...
            <strong class="input-content" style="font-family: 'Arial', 'Khmer OS Bokor', sans-serif;"> {{ exchangeRate + "(៛)"}}</strong>
          </div>
          <div class="form-row-content-detail row-content-view">
      ...
      <b-table style="font-family: 'Arial', 'Khmer OS Bokor', sans-serif;" 
