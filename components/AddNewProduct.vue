              ...
              <b-form v-if="show" enctype="multipart/form-data">
                <div class="full-content">
                  <div class="options" style="display: none;">
                    <b-form-checkbox id="is-purchase" name="is-purchase" value="is_purchase" v-model="is_purchases"
                      unchecked-value="not_purchase">ទំនិញនាំចូល</b-form-checkbox>
                  </div>
                  <div class="content-file-upload">
                    <b-form-file id="file" name="file" class="input-file" v-on:change="onFileChange" plain>
                    </b-form-file>
                ...
                <div class="full-content">
                  <b-row class="my-1">
                    ...
                    <b-col sm="4">
                      <b-form-input :id="'input-enname'" type="text" v-model="form.en_name" class="input-content">
                      </b-form-input>
                    </b-col>
                    <b-col sm="2"><label :for="'input-khname'" class="label-input">ឈ្មោះទំនិញជាខ្មែរ</label></b-col>
                    <b-col sm="4">
                      <b-form-input :id="'input-khname'" type="text" v-model="form.kh_name" class="input-content">
                      </b-form-input>
                    </b-col>
                  </b-row>
                  <b-row class="my-1">
                    ...
                    <b-col sm="4">
                      <b-form-select :id="'input-category'" class="form-control input-content" v-model="form.category"
                        :options="categories"></b-form-select>
                    </b-col>
                    <b-col sm="2"><label :for="'input-brand'" class="label-input">ប្រេនទំនិញ</label></b-col>
                    <b-col sm="4">
                      <b-form-select :id="'input-brand'" class="form-control input-content" v-model="form.brand"
                        :options="brands"></b-form-select>
                    </b-col>
                  </b-row>
                  <b-row class="my-1">
                    <b-col sm="2"><label :for="'input-sale_price'" class="label-input">តម្លៃលក់ ($)</label></b-col>
                    <b-col sm="4">
                      <b-form-input :id="'input-sale_price'" type="number" class="input-content"
                        v-model="form.sale_price"></b-form-input>
                    </b-col>
                    <b-col sm="2"><label :for="'input-description'" class="label-input">ការពិពណ៌នា</label></b-col>
                    <b-col sm="4">
                      <b-form-textarea :id="'input-description'" class="input-content" v-model="form.description">
                      </b-form-textarea>
                    </b-col>
                  </b-row>
                  <b-row class="my-1">
                    ...
                    <b-col sm="4">
                      <b-button type="submit" variant="primary" class="margin-right-20" @click="onSubmit">រក្សាទុក
                      </b-button>
